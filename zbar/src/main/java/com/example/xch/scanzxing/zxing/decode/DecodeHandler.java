...
package com.example.xch.scanzxing.zxing.decode;
...
import com.example.xch.scanzxing.zxing.R2;
        ...
        if (rawResult != null) {
            ...
            if (handler != null) {
                Message message = Message.obtain(handler,
                        R2.id.decode_succeeded, rawResult);
            ...
            if (handler != null) {
                Message message = Message.obtain(handler, R2.id.decode_failed);
                message.sendToTarget();
            }
        }
    }
